<main class="bg-light text-dark-emphasis">
    <section class="hero-section py-5 bg-primary-light">
        <div class="container text-center">
            ...
            <a href='/barberx/barbearias' style='--animate-duration: 1.6s;' class='btn btn-primary btn-lg fw-bold px-5 py-3 animate__animated animate__pulse animate__infinite'>Agendar já!</a>
        </div>
    </section>

    <section id="unidades" class="unidades-section py-5 bg-light-section">
        <div class="container">
            <h2 class="display-5 fw-bold mb-5 text-primary text-center">Nossas barbearias</h2>
                        ...
                        <div class="card h-100 bg-white shadow-lg border rounded-3 overflow-hidden d-flex flex-column animate__animated animate__fadeInUp">
                            ...
                            <div class="card-body d-flex flex-column justify-content-between">
                                <div>
                                    ...
                                    <p class="card-text text-dark-gray mb-1"><small><i class="fas fa-phone me-2"></i>Celular: <?= htmlspecialchars($bar->telefone) ?></small></p>
                                    <p class="card-text text-dark-gray mb-3"><small><i class="fas fa-map-marker-alt me-2"></i><?= htmlspecialchars($bar->endereco) ?></small></p>
                                </div>
                                <a href="/barberx/barbearia?id=<?= htmlspecialchars($bar->id) ?>" class="btn btn-outline-primary mt-auto">
    ...
    <section class="promo-section py-5 bg-primary-dark text-center">
        <div class="container d-flex flex-column flex-md-row align-items-center justify-content-around">
            <div class="promo-text-content mb-4 mb-md-0 me-md-5 animate__animated animate__fadeInLeft">
                ...
                <a href="/barberx/empresas" class="btn btn-light btn-lg fw-bold px-5 py-3 shadow-sm animate__animated animate__tada">Cadastre Sua Barbearia</a>
            </div>
